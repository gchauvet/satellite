 ...
 * helper program, classes that implement the <code>Daemon</code> interface can
...
public interface Daemon {
     ...
     * </p>
     *
     * @param context A <code>DaemonContext</code> object used to communicate
     * with the container.
     * @throws DaemonInitException An exception that prevented initialization
